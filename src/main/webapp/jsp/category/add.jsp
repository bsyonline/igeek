...
<!-- Form -->
<form action="${pageContext.request.contextPath}/category/saveOrUpdate" class="form" id="form1">
    <input type="hidden" name="id" value="${category.id}">
    <fieldset>
        <div class="widget">
            <div class="title">
                <img src="${pageContext.request.contextPath}/images/icons/dark/list.png" alt="" class="titleIcon"/>
                <h6><spring:message code="label.category.add" text="Category Add"/></h6>
            </div>
            <div class="formRow">
                ...
                <div class="formRight">
                    <span class="oneTwo">
                        <input id="name" type="text" name="name" value="${category.name}" class="validate[required]"/>
                    </span>
                </div>
                <div class="clear"></div>
            </div>
...
<script>
    function _submit() {
        if ($('#form1').validationEngine('validate')) {
            ...
            $("#content-wrapper").empty().load("${pageContext.request.contextPath}/category/saveOrUpdate", data);
        }
