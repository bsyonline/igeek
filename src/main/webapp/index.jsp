...
<nav class="navbar navbar-default templatemo-nav" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="#" class="navbar-brand">iGeek</a>
        </div>
...
<section id="home">
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8" id="ad-words">
...
<section id="team">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.3s">
                <div class="team-wrapper">
                    <img src="images/c.png" class="img-responsive" alt="team img 1">
                    <div class="team-des">
                        <h4>C</h4>
                    </div>
                </div>
            </div>
            <div class="col-md-2 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.6s">
                <div class="team-wrapper">
                    <img src="images/c.png" class="img-responsive" alt="team img 2">
                    <div class="team-des">
                        <h4>MARY</h4>
                    </div>
                </div>
            ...
            <div class="col-md-2 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.3s">
                <div class="team-wrapper">
                    <img src="images/c.png" class="img-responsive" alt="team img 3">
                    <div class="team-des">
                        <h4>JULIA</h4>
                    </div>
                </div>
            ...
            <div class="col-md-2 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.6s">
                <div class="team-wrapper">
                    <img src="images/c.png" class="img-responsive" alt="team img 4">
                    <div class="team-des">
                        <h4>LINDA</h4>
                    </div>
                </div>
