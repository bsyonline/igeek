	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='itemsPerPage' style='display:none'>Items per page:</span> _MENU_",
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select style="display:none" name="tableFilter" id="tableFilter" '+sName+'>';
			var i, iLen;
